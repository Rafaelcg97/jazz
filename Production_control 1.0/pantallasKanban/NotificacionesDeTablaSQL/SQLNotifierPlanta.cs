...
namespace Production_control_1._0.pantallasKanban.NotificacionesDeTablaSQL
{
    class SQLNotifierPlanta
    {
        ...
        public string ConnectionString
        {
            get
            {
                return "Data Source=" + ConfigurationManager.AppSettings["servidor_ing"] + ";Initial Catalog=" + ConfigurationManager.AppSettings["base_kanban"] + ";Persist Security Info=True;User ID=" + ConfigurationManager.AppSettings["usuario_ing"] + ";Password=" + ConfigurationManager.AppSettings["pass_ing"];
            }
        }
        ...
        public DataTable RegisterDependency()
        {
            ...
            this.CurrentCommand = new SqlCommand("select [solicitudKanbanId], [tipo], [modulo], [ubicacion], [atiendeSolicitud], [atiendeSolicitud], [fechaSolicitud], [fechaInicio], [fechaParcial], [fechaEntrega], [validadoSmed] from dbo.solicitudesKanban where [fechaEntrega] is null", this.CurrentConnection);
